...
export const Contact = () => {
  ...
  return (
    <AnimatedSection
      className="w-full bg-white from-amber-50 via-amber-100 to-amber-50 py-20"
      config={{
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="contact">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold uppercase text-center text-black mb-4">
        ...
        >
          <p className="text-xl md:text-2xl text-center text-black max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <input
                    ...
                    } focus:ring-2 focus:ring-amber-200 outline-none transition`}
                  />
                  {errors.name && (
                    <motion.span
