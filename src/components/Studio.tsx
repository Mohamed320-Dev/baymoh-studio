          ...
          <div className="w-[100%] md:w-[70%] mx-auto text-center">
            ...
            >
              <motion.span className="text-white block mt-8">
                Expert guidance in audiovisual production, studio rental, and
                original content creation awaits you here.
              </motion.span>
            </AnimatedSection>
                  ...
                  {[
                    {
                      ...
                      img: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=281,h=221,fit=crop/mxB75M8GpXFPvRla/0000000000-dOq4NXQ7grT8x0oE.png",
                    },
                    {
                      id: "visual_identity",
                      title: "Visual Identity",
                      img: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=281,h=221,fit=crop/mxB75M8GpXFPvRla/0-A1aJrgvv47fp6w9D.png",
                    },
                    {
                      id: "photography",
                      title: "Photography",
                      img: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=281,h=221,fit=crop/mxB75M8GpXFPvRla/000000-Yan9z2PPX5iOD2qL.png",
                    },
                    {
                      id: "content_video",
                      title: "Content Video",
                      img: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=268,h=245,fit=crop/mxB75M8GpXFPvRla/00-AVLbND66jqSBKQVb.png",
                    },
                    {
                      id: "marketing_digital",
                      title: "Marketing Digital",
                      img: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=226,h=221,fit=crop/mxB75M8GpXFPvRla/untitled-2-mjEqNn13jDIQeO3O.png",
                    },
                  ].map((service, index) => (
                    <AnimatedSection
                      key={service.id}
                ...
                >
                  <div className="text-center mt-20 text-white">
                    ...
                    <motion.span className="text-2xl font-semibold block mt-4">
                      Explore our diverse portfolio of innovative audiovisual
                      creations.
                    </motion.span>
                  </div>
                </AnimatedSection>
      ...
      <div className="bg-white py-20">
        ...
        >
          <div className="mx-auto text-center" id="content_creation">
            ...
            <motion.span className="text-xl font-semibold text-white block mt-4">
              Produce an engaging multimedia content series across podcast,
              Instagram Reels, YouTube videos, <br /> and targeted ads to
        ...
        >
          <div className="mx-auto text-center" id="content_video">
            ...
            <motion.span className="text-xl font-semibold text-white block mt-4">
              Raising the level of brand presence - an indication that visual
              identity designs help to raise the level <br /> of brand presence
              and position.
            </motion.span>
