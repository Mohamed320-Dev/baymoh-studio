    ...
    <div className="relative w-full">
        ...
        <div className="relative z-20 w-full pt-16 flex flex-col items-center justify-center px-4 py-6 text-center text-white">
          ...
          >
            <p className="text-xl md:text-2xl lg:text-xl max-w-2xl mx-auto leading-relaxed text-yellow-100">
              Where creative vision meets technical excellence - your premier
              partner for innovative audiovisual solutions
            </p>
          </AnimatedSection>
              ...
              {[
                {
                  name: "facebook",
                  color: "#3b5998",
                  link: "https://www.facebook.com/baymoh.prod/",
                },
                {
                  name: "instagram",
                  color: "#e1306c",
                  link: "https://www.instagram.com/baymoh_/",
                },
                {
                  name: "tiktok",
                  color: "#010101",
                  link: "https://www.tiktok.com/@baymoh_",
                },
              ].map((social, index) => (
                <motion.a
                  key={social.name}
      ...
      >
        <div className="flex flex-col lg:flex-row lg:w-[70%] w-[90%] mx-auto justify-between gap-8 lg:gap-16 py-8">
          <div className="w-full lg:w-[60%]">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-semibold uppercase mb-4 md:mb-6">
              Welcome
            </h1>
            <p className="text-base sm:text-lg md:text-xl font-light leading-relaxed">
              <span className="underline decoration-yellow-400">BAYMOH</span>, a
              leading company in the field of audiovisual production, digital
              education, and virtual events. We are proud to provide integrated
              solutions that help our clients excel in the rapidly evolving
              digital world.
              <br />
              <br />
              Since our establishment in 2022, despite the short duration, we
              have earned a distinguished reputation thanks to the expertise of
              our technical and creative team. We constantly strive to develop
              our skills and discover the latest technologies to be the ideal
              partner for our clients on their journey towards digital success.
            </p>
          </div>
          ...
          <div className="w-full lg:w-[40%] flex flex-col gap-4">
            ...
            <div className="bg-yellow-700 p-4 rounded-lg text-white flex justify-between items-center mt-[-40px] z-10 border border-yellow-500 shadow-lg shadow-yellow-900/30">
              <div className="text-center">
                <h1 className="text-2xl sm:text-3xl font-semibold text-yellow-200">
                  +150
                </h1>
      ...
      >
        <div className="w-[90%] lg:w-[70%] mx-auto text-center mt-20">
          <h1 className="text-5xl uppercase font-semibold mb-4">
            We are BAYMOH !!!
          </h1>
          <p className="mb-12">
            BAYMOH is a project that came about after years of extensive work
            during which we have learned various digital skills. Among the areas
            we currently offer are: 1. Audiovisual studio 2. Online education 3.
            Event organization
          </p>
            ...
            {[
              {
                ...
                desc: "We provide professional services in the field of photography and design, in all its forms and types. Whether it's producing a visual identity, a television commercial, or creating content for social media platforms, we are committed to delivering remarkable results.",
              },
              {
                img: service2,
      ...
      <AnimatedSection
        className="relative z-20 bg-[#ffb92e] from-amber-800 py-16 px-4 sm:px-8 md:px-16 lg:px-32 mt-20"
        config={{
          initial: { opacity: 0, y: 50 },
          animate: { opacity: 1, y: 0 },
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl sm:text-2xl text-amber-200 mb-12">
            Our collaborative partnerships have enabled us to drive impact and{" "}
            <br />
          ...
          <div className="flex flex-wrap gap-8 justify-center px-4">
            {[
              ...
              >
                <motion.div
                  className="w-32 h-32 md:w-32 md:h-32 rounded-lg p-4 flex items-center justify-center"
                  whileHover={{ scale: 1.1 }}
                >
                  <img
                    src={logo}
                    alt={`Client logo ${index + 1}`}
                    className="brightness-0 invert max-w-full max-h-full object-contain"
                  />
                </motion.div>
              </AnimatedSection>
            ))}
